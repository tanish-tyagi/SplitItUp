				...
				<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
					...
					<div class="card-deck mb-3 text-center">
						<div class="card mb-4 shadow-sm">
							<div class="card-header"><h4 class="my-0 font-weight-normal">Friends</h4></div>
							<img class="card-image-top" src="index/images/content img-3.png" style="padding: 2.5rem;">
							<div class="card-body"></div>
						</div>
						<div class="card mb-4 shadow-sm">
							<div class="card-header"><h4 class="my-0 font-weight-normal">Family</h4></div>
							<img class="card-image-top" src="index/images/content img-2.png" style="padding-top: 2.5rem; padding-left: 1rem; padding-right: 1rem; padding-bottom: 2.5rem;">
							<div class="card-body"></div>
						</div>
						<div class="card mb-4 shadow-sm">
							<div class="card-header"><h4 class="my-0 font-weight-normal">Your Profile</h4></div>
