<div class="jumbotron jumbotron-fluid text-center" style="margin-bottom:100px; max-height: 120px; margin-top: 20px">
    <div class="banner-text">
        <div class="col-xl-12 ">
            <a href="index.php" title="" class="navbar-brand">
                <span class="border-bottom">
                <img src="index/images/WebsterLogo.png" class="rounded" alt="Photo Not Found"
                     style="height: 180px; width: 195px; margin-top: 5px">
                </span>
            </a>
        </div>
    </div>
